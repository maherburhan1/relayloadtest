...
class IncidentTicketsEventTest {
    ...
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid incident ticket event">
        parsingAssertMessage = "Valid incident ticket event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("incidentid", "892624986");
        entity1.put("serviceitemid", "33329");
        entity1.put("ticketid", "879292ab-364a-e911-80f4-000d3a1144ba");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rpt_incidentlogtickets")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = IncidentTicketsOuterClass.IncidentTickets.newBuilder()
                .setServiceId(33329)
                .setTicketId("879292ab-364a-e911-80f4-000d3a1144ba")
        ...
        //<editor-fold desc="Incident ticket missing incidentid">
        parsingAssertMessage = "Incident ticket missing incidentid";
        ...
        //<editor-fold desc="Incident ticket missing ticketid">
        parsingAssertMessage = "Incident ticket missing ticketid";
        Map<String, String> entity3 = new HashMap<>(entity1);
        entity3.remove("ticketid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
        ...
        //<editor-fold desc="Incident ticket missing ticketid = -1">
        parsingAssertMessage = "Incident ticket missing ticketid = -1";
        Map<String, String> entity4 = new HashMap<>(entity1);
        entity4.replace("ticketid", "-1");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
