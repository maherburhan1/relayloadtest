...
import com.solarwinds.msp.ncentral.proto.entity.asset.PageFileOuterClass;
...
class PageFileEventTest {
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid page file event">
        parsingAssertMessage = "Valid page file event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("deleted", "false");

        entity1.put("contenthash", "4e7 b1e23");
        entity1.put("filename", "C:\\pagefile.sys");
        entity1.put("filesize", "123456");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("cim_pagefile")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = PageFileOuterClass.PageFile.newBuilder()
                .setDeviceId(1454030117)
                .setDeleted(false)
                .setFileName("C:\\pagefile.sys")
                .setFileSizeBytes(123456L)
        ...
        //<editor-fold desc="Page file event missing device id">
        parsingAssertMessage = "Page file event missing device id";
