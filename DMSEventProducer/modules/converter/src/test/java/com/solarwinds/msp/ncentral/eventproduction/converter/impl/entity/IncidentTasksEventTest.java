...
import com.solarwinds.msp.ncentral.proto.entity.tasks.IncidentTasksOuterClass;
...
class IncidentTasksEventTest {
    ...
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid incident task event">
        parsingAssertMessage = "Valid incident task event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("incidentid", "892624986");
        entity1.put("taskid", "231076130");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rpt_incidentlogtasks")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = IncidentTasksOuterClass.IncidentTasks.newBuilder()
                .setTaskId(231076130)
        ...
        //<editor-fold desc="Incident task missing incidentid">
        parsingAssertMessage = "Incident task missing incidentid";
        ...
        //<editor-fold desc="Incident task missing taskid">
        parsingAssertMessage = "Incident task missing taskid";
