...
import com.solarwinds.msp.ncentral.proto.entity.entity.SystemLimitsStickyOuterClass;
...
class SystemLimitsStickyEventTest {

    private static Stream<Arguments> parseRecordTest() {
        EventParserTestCases testCases = new EventParserTestCases();
        SystemLimitsStickyOuterClass.SystemLimitsSticky expectedResult;
        Event incomingEvent;
        String parsingAssertMessage;

        Map<String, String> entity = new HashMap<>();
        entity.put("starttimestamp", "2019-02-21T13:51:52.068Z");

        //<editor-fold desc="Valid system limits sticky event">
        parsingAssertMessage = "Valid system limits sticky event";
        Map<String, String> entity1 = new HashMap<>(entity);

        entity1.put("customerid", "101");
        entity1.put("shortdesc", "MaxCustomers");
        entity1.put("deviceid", "999");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("systemlimitssticky")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = SystemLimitsStickyOuterClass.SystemLimitsSticky.newBuilder()
                .setClientId(101)
                .setShortDescription("MaxCustomers")
                .setDeviceId(999)
                .setDisabledDate(Timestamp.newBuilder().setSeconds(1550757112).setNanos(68000000).build())
        ...
        //<editor-fold desc="System limits sticky event missing customer id">
        parsingAssertMessage = "System limits sticky event missing customer id";
        ...
        //<editor-fold desc="System limits sticky event missing short description">
        parsingAssertMessage = "System limits sticky event missing short description";
        Map<String, String> entity3 = new HashMap<>(entity);
        entity3.remove("shortdesc");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
        ...
        //<editor-fold desc="System limits sticky event missing deviceid">
        parsingAssertMessage = "System limits sticky event missing deviceid";
