...
class RuleCustomerEventTest {
    ...
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid rule customer event">
        parsingAssertMessage = "Valid rule customer event";
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rulecustomermap")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = RuleCustomerOuterClass.RuleCustomer.newBuilder()
                .setClientId(101)
                .setRuleId(502)
                .setDeleted(false)
