...
class UserLoggedTicketsEventTest {

    private static Stream<Arguments> parseRecordTest() {
        EventParserTestCases testCases = new EventParserTestCases();
        UserLoggedTicketsOuterClass.UserLoggedTickets expectedResult;
        Event incomingEvent;
        String parsingAssertMessage;

        Map<String, String> entity = new HashMap<>();
        entity.put("lastupdated", "2019-02-21T13:51:52.068Z");
        entity.put("taskid", "1866268547");
        entity.put("ticketid", "85d34c7f-fd90-e911-abc4-000d3a11461e");
        entity.put("ticketresolved", "t");
        entity.put("ticketresponse", "");
        entity.put("ticketurl",
                "https://app.mspmanager.com/helpDesk/helpDesk#/TicketDetail/85d34c7f-fd90-e911-abc4-000d3a11461e");
        entity.put("psatickethistoryid", "1337372018");

        //<editor-fold desc="Valid user logged ticket event">
        parsingAssertMessage = "Valid user logged ticket event";
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rsiuserloggedticketdetail")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = UserLoggedTicketsOuterClass.UserLoggedTickets.newBuilder()
                .setTaskId(1866268547)
                .setTicketId("85d34c7f-fd90-e911-abc4-000d3a11461e")
        ...
        //<editor-fold desc="User logged ticket event missing task id">
        parsingAssertMessage = "User logged ticket event missing task id";
        ...
        //<editor-fold desc="User logged ticket event missing ticketid">
        parsingAssertMessage = "User logged ticket event missing ticketid";
        Map<String, String> entity4 = new HashMap<>(entity1);
        entity4.remove("ticketid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
        ...
        //<editor-fold desc="User logged ticket event ticketid = -1">
        parsingAssertMessage = "User logged ticket event ticketid = -1";
        Map<String, String> entity5 = new HashMap<>(entity1);
        entity5.replace("ticketid", "-1");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
