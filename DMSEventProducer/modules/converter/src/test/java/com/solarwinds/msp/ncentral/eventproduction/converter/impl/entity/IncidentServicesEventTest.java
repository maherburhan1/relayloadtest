...
import com.solarwinds.msp.ncentral.proto.entity.tasks.IncidentServicesOuterClass;
...
class IncidentServicesEventTest {
    ...
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid incident service event">
        parsingAssertMessage = "Valid incident service event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("incidentid", "892624986");
        entity1.put("serviceitemid", "35715");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rpt_incidentlogservices")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = IncidentServicesOuterClass.IncidentServices.newBuilder()
                .setServiceId(35715)
        ...
        //<editor-fold desc="Incident service missing incidentid">
        parsingAssertMessage = "Incident service missing incidentid";
        ...
        //<editor-fold desc="Incident service missing serviceitemid">
        parsingAssertMessage = "Incident service missing serviceitemid";
        Map<String, String> entity3 = new HashMap<>(entity1);
        entity3.remove("serviceitemid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
