...
import com.solarwinds.msp.ncentral.proto.entity.tasks.IncidentDevicesOuterClass;
...
class IncidentDevicesEventTest {
    ...
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid incident device event">
        parsingAssertMessage = "Valid incident device event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("incidentid", "892624986");
        entity1.put("deviceid", "780409474");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("rpt_incidentlogdevices")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = IncidentDevicesOuterClass.IncidentDevices.newBuilder()
                .setDeviceId(780409474)
        ...
        //<editor-fold desc="Incident device missing incidentid">
        parsingAssertMessage = "Incident device missing incidentid";
        ...
        //<editor-fold desc="Incident device missing deviceid">
        parsingAssertMessage = "Incident device missing deviceid";
        Map<String, String> entity3 = new HashMap<>(entity1);
        entity3.remove("deviceid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
