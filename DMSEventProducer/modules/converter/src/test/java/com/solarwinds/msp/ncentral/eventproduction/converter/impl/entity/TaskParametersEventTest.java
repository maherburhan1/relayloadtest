...
import com.solarwinds.msp.ncentral.proto.entity.tasks.TaskParametersOuterClass;
...
class TaskParametersEventTest {

    private static Stream<Arguments> parseRecordTest() {
        EventParserTestCases testCases = new EventParserTestCases();
        TaskParametersOuterClass.TaskParameters expectedResult;
        Event incomingEvent;
        String parsingAssertMessage;

        Map<String, String> entity = new HashMap<>();
        entity.put("lastupdated", "2019-02-21T13:51:52.068Z");
        entity.put("taskid", "828666859");
        entity.put("pkey", "show_in_NOC");
        entity.put("pvalue", "true");
        entity.put("deleted", "f");
        entity.put("serviceid", "302");
        entity.put("ptype", "2");
        entity.put("foruseby", "");
        entity.put("source", "");

        //<editor-fold desc="Valid task parameter event">
        parsingAssertMessage = "Valid task parameter event";
        ...
        expectedResult = TaskParametersOuterClass.TaskParameters.newBuilder()
                .setTaskId(828666859)
                .setDeleted(false)
                .setParameterKey("show_in_NOC")
        ...
        //<editor-fold desc="Task parameter event missing task id">
        parsingAssertMessage = "Task parameter event missing task id";
        ...
        //<editor-fold desc="Task parameter event missing parameter key">
        parsingAssertMessage = "Task parameter event missing parameter key";
