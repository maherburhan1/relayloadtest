...
class SystemServiceEventTest {
    private static Stream<Arguments> parseRecordTest() {
        ...
        //<editor-fold desc="Valid system service event">
        parsingAssertMessage = "Valid system service event";
        Map<String, String> entity1 = new HashMap<>(entity);
        entity1.put("deleted", "false");
        entity1.put("contenthash", "16b22409");
        entity1.put("serviceid", "12345");
        entity1.put("servicename", "gupdate");
        entity1.put("executablename", "\"GoogleUpdate.exe\"");
        entity1.put("startuptype", "Auto");
        entity1.put("swrunsnmpindex", null);
        entity1.put("caption", "Servicio Google Update (gupdate)");
        entity1.put("useraccount", "");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("cim_service")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = SystemServiceOuterClass.SystemService.newBuilder()
        ...
        //<editor-fold desc="System service event missing device id">
        parsingAssertMessage = "System service event missing device id";
        ...
        //<editor-fold desc="System service event missing executable name">
        parsingAssertMessage = "System service event missing executable name";
        Map<String, String> entity3 = new HashMap<>(entity1);
        entity3.remove("executablename");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
