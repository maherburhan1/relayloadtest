...
import com.solarwinds.msp.ncentral.proto.entity.tasks.RemoteExecutionItemOuterClass;
...
class RemoteExecutionItemEventTest {

    private static Stream<Arguments> parseRecordTest() {
        EventParserTestCases testCases = new EventParserTestCases();
        RemoteExecutionItemOuterClass.RemoteExecutionItem expectedResult;
        Event incomingEvent;
        String parsingAssertMessage;

        Map<String, String> entity = new HashMap<>();
        entity.put("lastupdated", "2019-02-21T13:51:52.068Z");
        entity.put("remoteexecutionitemid", "546210712");
        entity.put("name", "Complexus Medical UniPoint Client Update (File Removed)");
        entity.put("customerid", "1366");
        entity.put("deleted", "f");
        entity.put("tasktype", "RemoteExecution");
        entity.put("description", "Complexus Medical UniPoint Client Update");
        entity.put("licensemode", "");
        entity.put("system", "f");

        //<editor-fold desc="Valid remote execution item event">
        parsingAssertMessage = "Valid remote execution item task event";
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("remoteexecutionitem")
                .entity(entity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = RemoteExecutionItemOuterClass.RemoteExecutionItem.newBuilder()
                .setClientId(1366)
                .setManagementTaskType(
                        ManagementTaskTypeOuterClass.ManagementTaskType.newBuilder().setName("RemoteExecution").build())
                .setName("Complexus Medical UniPoint Client Update (File Removed)")
                .setRemoteExecutionItemId(546210712)
                .setDeleted(false)
        ...
        //<editor-fold desc="Remote execution item event missing remoteexecutionitemid">
        parsingAssertMessage = "Remote execution item event missing remoteexecutionitemid";
        Map<String, String> entity2 = new HashMap<>(entity1);
        entity2.remove("remoteexecutionitemid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
