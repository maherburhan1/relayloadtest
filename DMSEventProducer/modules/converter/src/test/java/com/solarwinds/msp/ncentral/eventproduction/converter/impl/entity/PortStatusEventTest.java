...
class PortStatusEventTest {

    private static Stream<Arguments> parseRecordTest() {
        EventParserTestCases testCases = new EventParserTestCases();
        PortStatusOuterClass.PortStatus expectedResult;
        Event incomingEvent;
        String parsingAssertMessage;

        Map<String, String> portStatusEntity = new HashMap<>();
        portStatusEntity.put("lastupdated", "2019-02-21T13:51:52.068Z");
        portStatusEntity.put("deviceid", "30185527");

        //<editor-fold desc="Valid PortStatus event">
        parsingAssertMessage = "Valid PortStatus event";
        Map<String, String> portStatusEntity1 = new HashMap<>(portStatusEntity);
        portStatusEntity1.put("servicename", "testservice");
        portStatusEntity1.put("port", "777");
        portStatusEntity1.put("deleted", "false");
        ...
        incomingEvent = Event.builder()
                ...
                .entityType("cim_custom_ports")
                .entity(portStatusEntity1)
                .newValues(Collections.emptyMap())
                .build();

        expectedResult = PortStatusOuterClass.PortStatus.newBuilder()
        ...
        //<editor-fold desc="portStatus event missing device id">
        parsingAssertMessage = "portStatus event missing device id";
        Map<String, String> portStatusEntity2 = new HashMap<>(portStatusEntity);
        portStatusEntity2.remove("deviceid");
        incomingEvent = Event.builder()
                .entityDataTypes(Collections.EMPTY_MAP)
                .bizappsCustomerId("aaea6111-b13f-462b-9385-4f3baa7f0ccc")
                .ncentralServerGuid("225ed5bb-9e8e-4ad5-aa8c-7a018dc5ffa5")
